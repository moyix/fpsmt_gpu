...
__device__ bool jfs_nr_float32_is_nan(const jfs_nr_float32 value);
__device__ bool jfs_nr_float64_is_nan(const jfs_nr_float64 value);
...
__device__ jfs_nr_float32 jfs_nr_float32_add(JFS_NR_RM rm, const jfs_nr_float32 lhs,
                                  const jfs_nr_float32 rhs);
__device__ jfs_nr_float64 jfs_nr_float64_add(JFS_NR_RM rm, const jfs_nr_float64 lhs,
                                  const jfs_nr_float64 rhs);
__device__ jfs_nr_float32 jfs_nr_float32_sub(JFS_NR_RM rm, const jfs_nr_float32 lhs,
                                  const jfs_nr_float32 rhs);
__device__ jfs_nr_float64 jfs_nr_float64_sub(JFS_NR_RM rm, const jfs_nr_float64 lhs,
                                  const jfs_nr_float64 rhs);
__device__ jfs_nr_float32 jfs_nr_float32_mul(JFS_NR_RM rm, const jfs_nr_float32 lhs,
                                  const jfs_nr_float32 rhs);
__device__ jfs_nr_float64 jfs_nr_float64_mul(JFS_NR_RM rm, const jfs_nr_float64 lhs,
                                  const jfs_nr_float64 rhs);
__device__ jfs_nr_float32 jfs_nr_float32_div(JFS_NR_RM rm, const jfs_nr_float32 lhs,
                                  const jfs_nr_float32 rhs);
__device__ jfs_nr_float64 jfs_nr_float64_div(JFS_NR_RM rm, const jfs_nr_float64 lhs,
                                  const jfs_nr_float64 rhs);
// Computes (a * b) + c
__device__ jfs_nr_float32 jfs_nr_float32_fma(JFS_NR_RM rm, const jfs_nr_float32 a,
                                  const jfs_nr_float32 b,
                                  const jfs_nr_float32 c);
__device__ jfs_nr_float64 jfs_nr_float64_fma(JFS_NR_RM rm, const jfs_nr_float64 a,
                                  const jfs_nr_float64 b,
                                  const jfs_nr_float64 c);
__device__ jfs_nr_float32 jfs_nr_float32_sqrt(JFS_NR_RM rm, const jfs_nr_float32 value);
__device__ jfs_nr_float64 jfs_nr_float64_sqrt(JFS_NR_RM rm, const jfs_nr_float64 value);
...
__device__ jfs_nr_float64 jfs_nr_float64_rem(const jfs_nr_float64 lhs,
                                  const jfs_nr_float64 rhs);
__device__ jfs_nr_float32 jfs_nr_float32_round_to_integral(JFS_NR_RM rm,
                                                const jfs_nr_float32 value);
__device__ jfs_nr_float64 jfs_nr_float64_round_to_integral(JFS_NR_RM rm,
...
__device__ jfs_nr_float32 jfs_nr_convert_float64_to_float32(JFS_NR_RM rm,
                                                 const jfs_nr_float64 value);
